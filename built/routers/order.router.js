...
router.get('/allOrders', (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var orders, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 2:
                error_1 = _a.sent();
                res.status(http_status_1.HTTP_BAD_REQUEST).send('Failed to fetch orders');
                return [3 /*break*/, 3];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, order_model_1.OrderModel.findOne({ user: req.user.id, status: order_status_1.OrderStatus.NEW })];
