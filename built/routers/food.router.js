...
router.post('/add-food', (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var newFood, createdFood;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                newFood = {
...
router.delete('/delete/:foodId', (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var foodId, deletedFood;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                foodId = req.params.foodId;
                console.log('food id is', foodId);
                return [4 /*yield*/, food_model_1.FoodModel.findByIdAndDelete(foodId)];
            case 1:
                deletedFood = _a.sent();
                if (!deletedFood) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, food_model_1.FoodModel.findByIdAndUpdate(foodId, food, {
